    ...
    return (
        <div className="relative mt-3">
            ...
            <div className="flex justify-center mb-4 text-center">
                <div>
                    <button className="bg-gradient-to-r from-[#248DE4] to-[#243BE4] px-4 py-2 rounded- text-white rounded-sm">Browse All Courses</button>
                    <p className="text-sm text-gray-500 mt-2">Explore our wide range of courses</p>
                </div>
            </div>
        </div>
    );
