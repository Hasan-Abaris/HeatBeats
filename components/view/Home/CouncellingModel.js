  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.status === 200 && res.data.status === true) {
        ...
        setTimeout(() => {
          setIsOpen(false);
          setSubmitted(false); // reset back to form next time
        }, 3000);
      } else {
        setLoading(false);
        ...
        <div className="bg-white p-4 animate-slide-up">
          {!submitted ? (
            ...
            <div className="flex flex-col items-center justify-center text-center py-8">
              ...
              <h2 className="text-xl font-semibold mb-2">Awesome</h2>
              <p className="text-gray-600 text-sm">
                We have received your query. One of our Career Advisors will call you shortly.
              </p>
            </div>
          )}
        </div>
